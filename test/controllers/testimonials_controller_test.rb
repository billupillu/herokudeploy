...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { content: @testimonial.content, name: @testimonial.name, spree_user_id: @testimonial.spree_user_id }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { content: @testimonial.content, name: @testimonial.name, spree_user_id: @testimonial.spree_user_id }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
