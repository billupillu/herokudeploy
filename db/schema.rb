...
ActiveRecord::Schema.define(version: 20160302105546) do
  ...
  create_table "spree_artist_profiles", force: :cascade do |t|
  ...
  create_table "spree_dont_miss_outs", force: :cascade do |t|
    t.string   "dont_miss_out_img_file_name"
    t.string   "dont_miss_out_img_content_type"
    t.integer  "dont_miss_out_img_file_size"
    t.datetime "dont_miss_out_img_updated_at"
  ...
  create_table "spree_feature_menu_heads", force: :cascade do |t|
    t.string   "feature_menu_heading", limit: 40
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "spree_feature_menu_images", force: :cascade do |t|
  ...
  create_table "spree_feature_menu_subitems", force: :cascade do |t|
  ...
  create_table "spree_look_books", force: :cascade do |t|
    t.string   "heading1"
    t.string   "heading2"
    t.string   "url"
    t.string   "lookbook_img_file_name"
    t.string   "lookbook_img_content_type"
    t.integer  "lookbook_img_file_size"
    t.datetime "lookbook_img_updated_at"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "spree_slider_banners", force: :cascade do |t|
    t.string   "url"
    t.string   "slider_banner_img_file_name"
    t.string   "slider_banner_img_content_type"
    t.integer  "slider_banner_img_file_size"
    t.datetime "slider_banner_img_updated_at"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "spree_testimonial_banners", force: :cascade do |t|
    t.integer  "position"
    t.string   "testimonial_banner_img_file_name"
    t.string   "testimonial_banner_img_content_type"
    t.integer  "testimonial_banner_img_file_size"
    t.datetime "testimonial_banner_img_updated_at"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  add_index "testimonials", ["spree_user_id"], name: "index_testimonials_on_spree_user_id", using: :btree

  add_foreign_key "testimonials", "spree_users"
end
